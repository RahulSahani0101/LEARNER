  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 gap-4 xl:grid-cols-[1.3fr_1fr]">
        ...
        <GlassCard>
          <h3 className="font-heading text-lg font-semibold">Recommended Courses</h3>
 ...
 */
export function TopicProgressItem({ topic }: TopicProgressItemProps) {
  return (
    <article className="rounded-xl border border-white/10 bg-white/5 p-3">
      ...
      <p className="mt-1 text-xs text-brand-muted">{topic.category.replaceAll("_", " ")}</p>
