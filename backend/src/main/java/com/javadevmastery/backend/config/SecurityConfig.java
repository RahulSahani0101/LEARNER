...
import com.javadevmastery.backend.auth.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    public SecurityConfig(
            ...
            @Value("${app.cors.allowed-origin-patterns:http://localhost:5173,http://localhost}") String allowedOriginPatterns
    ) {
